...
def load_data(mode="train"):
    ...
    if mode=="train":
        ...
        transcript = os.path.join(hp.transcript, 'transcript.txt')
    ...
    with tf.device('/cpu:0'):
        ...
        if hp.prepro:
            def _load_spectrograms(fpath):
                ...
                mel = "wolf/mels/{}".format(fname.decode("utf-8").replace("wav", "npy"))
                mag = "wolf/mags/{}".format(fname.decode("utf-8").replace("wav", "npy"))
